...
cd $temp_app_path
npx create-react-app test-kitchensink --internal-testing-template="$root_path"/packages/react-scripts/fixtures/kitchensink --scripts-version=@just-boris/preact-scripts
